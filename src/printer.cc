...
void Printer::Base::print(const Type::Base &t) { t.print(*this); }
...
std::string &Printer::Base::indent() { return indent_string; }
...
void Printer::Base::begin_fwd_decls() { fwd_decls = true; }

void Printer::Base::end_fwd_decls() { fwd_decls = false; }
